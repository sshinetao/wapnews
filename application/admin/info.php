  ...
  <div class="admin-content">
    ...
    <?php
        ...
        if (isset($_POST['savePassword'])){
            $query = "update wap_admin set admin_password = md5('{$_POST['admin_password']}') where admin_id = {$_GET['id']}";
            var_dump($query);
            execute($link, $query);
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <div class="am-form am-form-horizontal" >
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-weibo" placeholder="输入你的密码 / Password" name="admin_password">
               <small>输入你的密码。</small>
            </div>
          </div>

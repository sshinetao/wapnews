...
<head>
  ...
  <title>WAPNEWS - <?php echo $title;?></title>
...
<header class="am-topbar admin-header">
  <div class="am-topbar-brand">
    <strong>WAPNEWS</strong> <small>后台管理</small>
  </div>
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
          <span class="am-icon-users"></span> <?php echo $_COOKIE['manage']['manage_name']?> <span class="am-icon-caret-down"></span>
        </a>
        <ul class="am-dropdown-content">
          <li><a href="info.php?id=<?php echo $_COOKIE['manage']['manage_id']?>&flag=manage"><span class="am-icon-user"></span> 资料</a></li>
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
       ...
       <li><a href="news_list.php"><span class="am-icon-table"></span> 新闻列表</a></li>
        <li><a href="news_add.php"><span class="am-icon-pencil-square-o"></span> 添加新闻</a></li>
          </ul>
        </li>

...
/* $query_category_son = "select * from wap_news_category
where category_parent_id = {$_GET['id']} order by category_porder,category_id desc";
//var_dump($query_category);
$result_category_son = execute($link, $query_category_son);
$data_category_son = mysqli_fetch_assoc($result_category_son);
//var_dump($data_category['category_id']); */
$query_category = "select category_name,category_id from wap_news_category where category_id = {$data['category_parent_id']}";
...
<ol style="padding-left: 10px" class="am-breadcrumb am-breadcrumb-slash">
	...
	<li><a href="category.php?id=<?php echo $data_category['category_id']?>"><?php echo $data_category['category_name']?></a></li>
...
category_id ={$_GET['id']} order by category_porder,category_id desc";
